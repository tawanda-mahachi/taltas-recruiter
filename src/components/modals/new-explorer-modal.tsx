...
export function NewExplorerModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} maxWidth="640px">
      ...
      {step === 0 && (<div>
        <div className="text-[19px] font-semibold mb-[2px]" style={{ fontFamily: "'Roboto Slab', serif", color: 'var(--text-bright)' }}>Configure Explorer</div>
        <div className="text-[11.5px] mb-[16px]" style={{ color: 'var(--text-dim)' }}>Set up the AI screening agent for a role — it will autonomously engage and evaluate candidates.</div>
      ...
      {step === 1 && (<div>
        <div className="text-[19px] font-semibold mb-[2px]" style={{ fontFamily: "'Roboto Slab', serif", color: 'var(--text-bright)' }}>Screening Configuration</div>
        <div className="text-[11.5px] mb-[16px]" style={{ color: 'var(--text-dim)' }}>Define what the Explorer evaluates and custom screening questions.</div>
      ...
      {step === 2 && (<div>
        <div className="text-[19px] font-semibold mb-[2px]" style={{ fontFamily: "'Roboto Slab', serif", color: 'var(--text-bright)' }}>Review Explorer</div>
        <div className="text-[11.5px] mb-[16px]" style={{ color: 'var(--text-dim)' }}>Confirm your Explorer configuration before activating.</div>

        <div className="p-[16px] rounded-[10px] mb-[12px]" style={{ background: 'var(--surface2)', border: '1px solid var(--border)' }}>
          <div className="flex items-center gap-[10px] mb-[10px]">
            ...
            <div>
              <div className="text-[15px] font-semibold" style={{ fontFamily: "'Roboto Slab', serif", color: 'var(--text-bright)' }}>{form.name || 'Unnamed Explorer'}</div>
