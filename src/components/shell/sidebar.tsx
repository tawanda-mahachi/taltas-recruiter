...
const NAV = [
  ...
  { href: '/jobs',         label: 'Jobs',          group: 'Hiring',
  ...
  { href: '/clients',     label: 'Clients',      group: 'Agency', agencyOnly: true,
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="0"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M12 12v5"/><path d="M9 15h6"/></svg> },
...
export function Sidebar() {
  ...
  const accountType = (user as any)?.accountType || 'direct';
  ...
  return (
    <aside style={{ width: 180, minWidth: 180, height: '100vh', background: '#FFFFFF', borderRight: '1px solid ' + BORDER, display: 'flex', flexDirection: 'column', fontFamily: F, flexShrink: 0 }}>
      ...
      <nav style={{ flex: 1, overflowY: 'auto', padding: '8px 0' }}>
        {NAV.filter(item => !item.agencyOnly || isAgency).map(item => {
