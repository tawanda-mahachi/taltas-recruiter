        ...
        {(() => {
          ...
          return NAV.map(item => {
            ...
            return (
              <div key={item.href}>
                {showGroup && (
                  <div style={{ fontFamily:"'Helvetica Neue',Helvetica,Arial,sans-serif", fontSize: 9, fontWeight: 500, color: 'var(--muted)', letterSpacing: '.16em', textTransform: 'uppercase', padding: '20px 20px 2px', opacity: 0.5 }}>
                    {item.group}
                  </div>
                )}
                <button
