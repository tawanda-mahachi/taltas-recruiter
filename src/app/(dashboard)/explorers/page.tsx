  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', fontFamily: F, overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        {/* Header */}
        <div style={{ display: 'grid', gridTemplateColumns: '220px 180px 80px 120px 70px 80px 80px 90px 110px 110px', alignItems: 'center', padding: '0 20px', height: 34, background: BLIGHT, borderBottom: '1px solid ' + BORDER, position: 'sticky', top: 0, zIndex: 5 }}>
        ...
        {filtered.map((e, i) => {
          ...
          return (
            <div key={e.id || i}
              ...
              style={{ display: 'grid', gridTemplateColumns: '220px 180px 80px 120px 70px 80px 80px 90px 110px 110px', alignItems: 'center', padding: '0 20px', height: 54, borderBottom: '1px solid ' + BLIGHT, cursor: 'pointer', transition: 'background .1s', opacity: isDraft ? .7 : 1 }}
