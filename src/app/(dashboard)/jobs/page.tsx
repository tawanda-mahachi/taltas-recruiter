      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        {showBank && filterBank.length > 0 && (
          <div>
            ...
            {/* Bank header */}
            <div style={{ display: 'grid', gridTemplateColumns: '260px 140px 120px 80px 130px 120px 1fr', alignItems: 'center', padding: '0 20px', height: 34, background: BLIGHT, borderBottom: '1px solid ' + BORDER, position: 'sticky', top: 0, zIndex: 5 }}>
            ...
            {filterBank.map((j, i) => (
              <div key={i}
                style={{ display: 'grid', gridTemplateColumns: '260px 140px 120px 80px 130px 120px 1fr', alignItems: 'center', padding: '0 20px', height: 52, borderBottom: '1px solid ' + BLIGHT, cursor: 'pointer', transition: 'background .1s' }}
