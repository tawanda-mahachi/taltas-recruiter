...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â PUB NAV ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â matches landing page nav fonts exactly ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â REUSABLE STYLES ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
const S = {
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â HELP CENTER ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
const HC_SECTIONS = [
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬', title: 'Getting Started', desc: 'Set up your workspace, connect your ATS, and launch your first Explorer Agent.', articles: ['Creating your first Explorer Agent', 'Connecting Greenhouse, Lever, or Workday', 'Understanding the Deep Match score', 'Inviting your team to Taltas'] },
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¤ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“', title: 'Explorer Agents', desc: 'Configure, train, and manage your screening agents.', articles: ['Configuring evaluation focus areas', 'Setting compensation bands for negotiation', 'Assist vs. Auto mode explained', 'Reviewing and editing agent conversations', 'Pausing and archiving agents'] },
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â ', title: 'Pipeline & Reports', desc: 'Understand your pipeline data and export insights.', articles: ['Reading the Pipeline dashboard', 'Exporting candidate reports', 'Setting up bottleneck alerts', 'Sharing shortlists with hiring managers'] },
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â', title: 'Integrations', desc: 'Connect Taltas to your existing stack.', articles: ['Supported ATS integrations', 'Setting up Rippling sync', 'Webhook configuration', 'Troubleshooting sync errors'] },
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢', title: 'Security & Compliance', desc: 'Data handling, GDPR, and account security.', articles: ['Enabling SSO / SAML', 'Responding to candidate data requests', 'Downloading your data export', 'Managing team permissions'] },
  { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¬', title: 'Billing & Plans', desc: 'Subscriptions, invoices, and plan changes.', articles: ['Upgrading or downgrading your plan', 'Understanding usage limits', 'Downloading invoices', 'Cancellation and data retention'] },
];
    ...
    <>
      ...
      <div style={{ ...S.container, paddingTop: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: '#fff', border: '1px solid rgba(0,0,0,.1)', borderRadius: 10, padding: '14px 20px', marginBottom: 48, boxShadow: '0 1px 4px rgba(0,0,0,.04)' }}>
          ...
          <input type="text" placeholder="Search the help centerÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦" value={search} onChange={e => setSearch(e.target.value)} style={{ border: 'none', outline: 'none', fontSize: 14, color: '#0f172a', background: 'transparent', flex: 1, fontFamily: 'var(--font-sans)' }}/>
        </div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â API REFERENCE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function ApiRefPage() {
  return (
    <>
      ...
      <div style={{ ...S.container, paddingTop: 0 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 56 }}>
          ...
          <div>
            ...
            <p style={S.body}>All API requests require a secret key passed in the <code style={{ ...S.mono, fontSize: 12, background: '#f1f5f9', color: '#0f172a', padding: '1px 5px', borderRadius: 4 }}>Authorization</code> header. Keys are scoped to your workspace and can be created in Settings ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ API Keys.</p>
            ...
            <div style={{ margin: '20px 0' }}><div style={{ ...S.mono, fontSize: 9, textTransform: 'uppercase', letterSpacing: '.12em', color: '#94a3b8', marginBottom: 8 }}>Authentication header</div><div style={{ background: '#0f172a', color: '#e2e8f0', ...S.mono, fontSize: 12.5, padding: '16px 20px', borderRadius: 8 }}>Authorization: Bearer sk_live_ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢</div></div>
  ...
  "next_cursor": "cnd_01HX3..."
            ...
            <p style={S.body}>Taltas sends webhook events when key things happen. Configure your endpoint in Settings ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ Webhooks.</p>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â STATUS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
const INCIDENTS = [
  { date: 'Dec 3, 2025', title: 'Rippling sync delay ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'A race condition in the Rippling webhook handler caused candidate status updates to lag by up to 4 minutes under high load. Resolved with a queue-backed retry mechanism. Duration: 2h 14m. No data was lost.' },
  { date: 'Nov 11, 2025', title: 'Elevated Explorer Agent response times ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'An upstream model provider experienced elevated latency between 14:22ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ16:05 UTC, causing Explorer Agent conversations to load slowly for some users. Candidate scoring was unaffected. Duration: 1h 43m.' },
  { date: 'Oct 28, 2025', title: 'Deep Match scores delayed on shortlist ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'A database migration introduced a caching bug that caused newly screened candidates to appear on the shortlist without Deep Match scores populated for up to 12 minutes. Duration: 52m.' },
  { date: 'Oct 9, 2025', title: 'Greenhouse webhook delivery failures ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'Greenhouse updated their webhook signature algorithm without advance notice, causing our verification layer to reject valid payloads. All missed events were backfilled after the fix. Duration: 3h 31m.' },
  { date: 'Sep 14, 2025', title: 'Email notification delivery degraded ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'Our email delivery provider experienced an incident affecting transactional email for all customers. Shortlist notifications and candidate rejection emails were delayed by 20ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ90 minutes. Duration: 1h 08m.' },
  { date: 'Aug 22, 2025', title: 'Dashboard intermittently unavailable ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Resolved', body: 'A bad deploy introduced a null-pointer exception in the pipeline data aggregation layer, causing the dashboard to return 500 errors for approximately 18% of page loads. Rolled back within 24 minutes. Duration: 24m.' },
];
    ...
    <>
      ...
      <div style={{ ...S.container, paddingTop: 0 }}>
        ...
        <div style={{ marginTop: 56 }}>
          <div style={{ ...S.eyebrow, marginBottom: 24 }}>Incident history ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â last 6 months</div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â COMMUNITY ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
const COMM_POSTS = [
  { initials: 'MR', name: 'Maya Rosenberg', role: 'Head of Talent ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Fintech', time: '2h ago', text: "We've been running Explorer Agents in assist mode for 4 weeks before switching to auto. Big recommend ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â gives your team time to calibrate trust in the scores before handing over full control.", replies: 12 },
  { initials: 'DK', name: 'David Kim', role: 'Recruiter ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Series B SaaS', time: '5h ago', text: 'Anyone else found that weighting Curiosity Signal higher than default significantly improves engineer hire quality? We bumped it to 1.4x and the shortlist got noticeably better.', replies: 8 },
  { initials: 'SL', name: 'Sophie Laurent', role: 'TA Lead ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Healthcare', time: 'Yesterday', text: "For anyone integrating with Greenhouse: make sure you set up the webhook before you create your first agent, not after. Learned this the hard way ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â candidates screened before the webhook is live won't sync automatically.", replies: 5 },
  { initials: 'TN', name: 'Tom Nakamura', role: 'Recruiter ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Consumer Tech', time: '2 days ago', text: "Just had our first Agent-to-Agent negotiation session complete. The alignment summary was surprisingly good ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â it surfaced a start date conflict that would have delayed the offer by two weeks if we'd caught it at the offer stage.", replies: 19 },
];
      ...
      <div style={{ ...S.container, paddingTop: 0 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr 220px', gap: 32 }}>
          <div>
            ...
            {['ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¬ General', 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¤ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Explorer Agent Config', 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â  Pipeline & Reporting', 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Integrations', 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¡ Feature Requests', 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã‚Âº Bug Reports'].map((ch, i) => (
    ...
    <>
      ...
      <div style={{ ...S.container, paddingTop: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <button onClick={handleSend} disabled={sent || !name || !email || !message} style={{ ...S.btnPrimary, fontSize: 11, padding: '12px 28px', opacity: (!name || !email || !message) ? 0.6 : 1 }}>
...
function SecurityPage() {
  const cards = [
    { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢', title: 'Encryption', body: 'All data encrypted in transit via TLS 1.3 and at rest via AES-256. Conversation transcripts are stored in per-tenant isolated data stores with no cross-tenant access.' },
    { icon: 'ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦', title: 'SOC 2 Type II', body: 'Annually audited by a Big Four firm. Current certificate available on request. Covers security, availability, and confidentiality trust service criteria.' },
    { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂºÃƒâ€šÃ‚Â¡ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â', title: 'Access controls', body: 'Role-based access control with SSO/SAML support. MFA enforced for all accounts. Privileged access requires just-in-time approval with full audit logging.' },
    { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â', title: 'Vulnerability disclosure', body: 'Responsible disclosure programme at security@taltas.ai. We aim to triage reports within 24 hours and patch critical vulnerabilities within 72 hours.' },
    { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â', title: 'Infrastructure', body: 'Hosted on AWS with multi-region redundancy. No shared infrastructure between tenants. Network segmentation and WAF on all public endpoints.' },
    { icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹', title: 'Penetration testing', body: 'Bi-annual penetration tests conducted by independent third parties. Findings and remediation timelines shared with Enterprise customers under NDA.' },
  ];
  return (
    <>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â INVESTORS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
      ...
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center', marginBottom: 72 }}>
          <div>
            ...
            <p style={S.body}>Taltas has raised $22M to date from investors with deep experience in enterprise software, AI infrastructure, and HR technology. Our investors are active partners ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â they&apos;ve made introductions, challenged our assumptions, and helped us build a business designed to last.</p>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â CASE STUDIES ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
      ...
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 1, background: 'rgba(0,0,0,.07)', border: '1px solid rgba(0,0,0,.07)' }}>
          <div style={{ gridColumn: '1 / -1', background: '#eff6ff', padding: '44px 40px' }}>
            <div style={{ ...S.mono, fontSize: 10, color: '#94a3b8', letterSpacing: '.06em', textTransform: 'uppercase', marginBottom: 12 }}>Fintech ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Series C ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· 420 employees</div>
            ...
            <p style={{ fontSize: 13.5, color: '#64748b', lineHeight: 1.75, marginBottom: 20 }}>Meridian&apos;s talent team was spending 22 hours per week on phone screens for a single engineering role. After deploying Explorer Agents, they reduced that to 3 hours ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â while improving offer acceptance from 48% to 71%.</p>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â PRESS KIT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
      ...
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start', marginBottom: 72 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 1, background: 'rgba(0,0,0,.07)', border: '1px solid rgba(0,0,0,.07)' }}>
              {[['Logo Pack', 'SVG, PNG ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Light & Dark variants'], ['Brand Guidelines', 'PDF ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· 24 pages'], ['Product Screenshots', 'ZIP ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Hi-res PNG'], ['Executive Headshots', 'ZIP ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Hi-res JPG'], ['Company Fact Sheet', 'PDF ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· 2 pages']].map(([name, meta]) => (
                <div key={name} style={{ background: '#fff', padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
                  ...
                  <button style={{ ...S.mono, fontSize: 10, letterSpacing: '.08em', textTransform: 'uppercase', background: 'none', border: '1px solid rgba(0,0,0,.12)', padding: '7px 14px', borderRadius: 6, cursor: 'pointer', color: '#374151', whiteSpace: 'nowrap' }}>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Download</button>
                </div>
              ))}
            </div>
          </div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â PARTNERS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function PartnersPage({ router }: { router: ReturnType<typeof useRouter> }) {
  ...
  return (
    <>
      <div style={S.hero}><div style={S.eyebrow}>Partners</div><h1 style={S.h1}>The ecosystem around Taltas.</h1><p style={S.sub}>Taltas integrates with the platforms your team already uses ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â from HR systems and ATS to job boards and staffing networks.</p></div>
      <div style={{ ...S.container, paddingTop: 0 }}>
        {tracks.map(t => (
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â ABOUT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function AboutPage({ router }: { router: ReturnType<typeof useRouter> }) {
  return (
    <>
      <div style={S.hero}><div style={S.eyebrow}>Company</div><h1 style={S.h1}>Making hiring human again.</h1><p style={S.sub}>Taltas exists because the recruiting industry is broken ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â not by the people in it, but by the tools they&apos;re forced to use.</p></div>
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start', marginBottom: 72 }}>
          <div>
            <h2 style={S.h2}>Our story</h2>
            <p style={S.body}>The average recruiter spends 23 hours per week on phone screens. Most of those conversations end in rejection within the first five minutes. The candidates who survive often aren&apos;t the best ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â they&apos;re the best at interviewing.</p>
            <p style={S.body}>We built Taltas to change that. Our Explorer Agents don&apos;t just screen ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â they listen. They evaluate candidates across six dimensions of fit, surface hidden strengths traditional methods miss, and give every candidate a fair, consistent experience.</p>
          </div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â CAREERS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function CareersPage() {
  const jobs = [
    { title: 'Senior Backend Engineer', meta: 'Engineering ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· San Francisco ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Full-time' },
    { title: 'ML Research Engineer', meta: 'AI Team ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Remote ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Full-time' },
    { title: 'Product Designer', meta: 'Design ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· San Francisco ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Full-time' },
    { title: 'Solutions Engineer', meta: 'Go-to-market ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· New York ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Full-time' },
    { title: 'Developer Advocate', meta: 'DevRel ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Remote ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Full-time' },
  ];
  return (
    <>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â CHANGELOG ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function ChangelogPage() {
  ...
  return (
    <>
      <div style={S.hero}><div style={S.eyebrow}>Changelog</div><h1 style={S.h1}>What&apos;s new in Taltas.</h1><p style={S.sub}>Product updates, improvements, and fixes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â shipped roughly every two weeks.</p></div>
          ...
          {entries.map((e, i) => {
            ...
            return (
              <div key={i} style={{ padding: '48px 0', borderBottom: '1px solid rgba(0,0,0,.07)', ...(i === 0 ? { paddingTop: 0 } : {}) }}>
                ...
                {e.details.length > 0 && <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>{e.details.map((d, j) => <div key={j} style={{ ...S.mono, fontSize: 11, color: '#64748b', letterSpacing: '.03em' }}>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ {d}</div>)}</div>}
              </div>
            );
          })}
        </div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â BLOG ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function BlogPage() {
  return (
    <>
      ...
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 1, background: 'rgba(0,0,0,.07)', border: '1px solid rgba(0,0,0,.07)', marginBottom: 48 }}>
          <div style={{ background: '#fff', padding: '48px 44px' }}>
            ...
            <p style={{ fontSize: 13.5, color: '#64748b', lineHeight: 1.75, marginBottom: 16 }}>We analysed 14,000 phone screen transcripts from 120 companies and found that 73% of rejections happen in the first 4 minutes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â before any substantive evaluation occurs.</p>
            <div style={{ ...S.mono, fontSize: 11, color: '#94a3b8', letterSpacing: '.04em' }}>Feb 12, 2026 ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· 8 min read</div>
          </div>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â INSIGHTS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
  ...
  return (
    <>
      ...
      <div style={S.container}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 1, background: 'rgba(0,0,0,.07)', border: '1px solid rgba(0,0,0,.07)' }}>
          {[
            { tag: 'Annual Report', title: 'State of AI Recruiting 2026', body: 'How 380+ companies are using AI agents in their hiring workflows ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â and what the data says about outcomes.', featured: true },
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â RESEARCH PAPERS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
function PapersPage() {
  const papers = [
    { title: 'Deep Match: Multi-dimensional candidate scoring through conversational AI', authors: 'Patel, A., Chen, J., Okafor, E. ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Taltas Research, 2026', abstract: 'We present Deep Match, a scoring framework that evaluates candidates across six orthogonal dimensions using structured conversational signals. On a held-out set of 8,400 hire/no-hire outcomes, Deep Match achieves 0.91 AUC.' },
    { title: 'Measuring the Curiosity Signal in unstructured interviews', authors: 'Patel, A., Kim, M. ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Taltas Research, 2025', abstract: 'We introduce a method for extracting and scoring candidate curiosity from free-form conversation transcripts. Our approach combines turn-taking analysis with semantic probing to identify genuine intellectual engagement.' },
    { title: 'Bias auditing in AI-assisted hiring: a framework for continuous measurement', authors: 'Rodriguez, S., Patel, A. ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Taltas Research, 2025', abstract: 'We propose a bias auditing framework that continuously measures demographic parity, equalised odds, and calibration across all six Deep Match scoring dimensions.' },
  ];
  return (
    <>
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â STANDARD LEGAL PAGES ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
...
const STANDARD_PAGES: Record<string, StdPage> = {
  privacy: { label: 'Legal', title: 'Privacy Policy', subtitle: 'Last updated: February 1, 2026', content: [
    ...
    { heading: '6. Contact', body: 'Privacy questions: privacy@taltas.ai ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Data Protection Officer: dpo@taltas.ai ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Taltas Inc., 340 Pine Street, San Francisco, CA 94104' },
  ]},
  ...
  cookie: { label: 'Legal', title: 'Cookie Policy', subtitle: 'Last updated: February 1, 2026', content: [
    ...
    { heading: 'Cookies we use', body: 'Essential cookies ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Required for the platform to function. These include session tokens, CSRF protection, and authentication state. You cannot opt out of these.\n\nPreference cookies ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Remember your settings, such as dashboard layout and notification preferences. Retained for 12 months.\n\nAnalytics cookies ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Help us understand usage patterns to improve the product. We use privacy-first analytics (no cross-site tracking, no fingerprinting). You can opt out in Account Settings.' },
  ...
  gdpr: { label: 'Legal', title: 'GDPR Compliance', subtitle: 'Taltas is designed to help you comply with the General Data Protection Regulation. Here\'s how.', content: [
    { heading: 'Our role under GDPR', body: 'When you use Taltas to evaluate candidates, you are the data controller ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â you determine the purposes and means of processing candidate data. Taltas acts as a data processor, processing candidate data only on your instructions.\n\nWe have a Data Processing Agreement (DPA) available for all customers. Enterprise customers can request a signed DPA from their account manager.' },
    ...
    { heading: 'DPA & contact', body: 'To request a Data Processing Agreement or reach our DPO: dpo@taltas.ai ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· Taltas Inc., 340 Pine Street, San Francisco, CA 94104' },
  ]},
};
...
/* ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â MAIN PAGE COMPONENT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â */
